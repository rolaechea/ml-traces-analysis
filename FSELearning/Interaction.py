...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 15 18:33:42 2019
...
class Interaction(object):
    ...
    def __init__(self, InfluenceFunctionModellingInteraction):
        """
        builds an interactino container.
        
        Parameters
        ----------
        InfluenceFunctionModellingInteraction : InfluenceFunction
        """
        self.binaryOptions = []
        
        for aBinaryOptionParticipating in InfluenceFunctionModellingInteraction.participatingBoolOptions:
            self.binaryOptions.append(aBinaryOptionParticipating)
